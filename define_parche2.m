function [vertices_parche,caras_parche]=define_parche2(vertices,caras,normales,borde_hueco,entorno,Cmax,factor_limite)
...
caras_parche=caras(unique(caras_parche_ind),:);
